...
knitr::include_graphics(
  system.file("scorecardbuilder_shiny/www/binning-woe.png",
...
knitr::include_graphics(
  system.file("scorecardbuilder_shiny/www/binning-iv.png",
              package = "scorecardbuilder")
)
```
...
knitr::include_graphics(
  system.file("scorecardbuilder_shiny/www/binning-numeric.png",
              package = "scorecardbuilder")
)
```
...
knitr::include_graphics(
  system.file("scorecardbuilder_shiny/www/binning-character.png",
              package = "scorecardbuilder")
)
```